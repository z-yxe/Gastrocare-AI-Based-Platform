...
// Fetch questions for session 2
$questions = $conn->query("SELECT * FROM questions WHERE session = 2 ORDER BY id");
?>
...
<head>
    ...
    <title>Sesi 2: Kebiasaan Makan</title>
    ...
    <div class="container1">
        <form id="diagnosis-form" onsubmit="saveFormData(event, 'session3.php')">
            ...
            <div class="navigation-buttons">
                <a href="session1.php" class="btn secondary">Kembali</a>
