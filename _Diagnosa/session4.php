...
// Fetch questions for session 4
$questions = $conn->query("SELECT * FROM questions WHERE session = 4 ORDER BY id");
?>
...
<head>
    ...
    <title>Sesi 4: Gejala Fisik Lanjutan</title>
    ...
    <div class="container1">
        <form id="diagnosis-form" onsubmit="saveFormData(event, 'session5.php')">
            ...
            <div class="navigation-buttons">
                <a href="session3.php" class="btn secondary">Kembali</a>
