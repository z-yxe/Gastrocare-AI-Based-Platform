...
// Fetch questions for session 6
$questions = $conn->query("SELECT * FROM questions WHERE session = 6 ORDER BY id");
?>
...
<head>
    ...
    <title>Sesi 6: Faktor Psikologis</title>
...
<body>
    ...
    <div class="progress-container">
        ...
        <div class="steps">
            ...
            <div class="step active" data-step="4"><span>4</span></div>
            <div class="step active" data-step="5"><span>5</span></div>
            <div class="step active" data-step="6"><span>6</span></div>
        </div>
    </div>
    ...
    <div class="container1">
        <form id="diagnosis-form" onsubmit="saveFormData(event, 'result.php')">
            ...
            <div class="navigation-buttons">
                <a href="session5.php" class="btn secondary">Kembali</a>
