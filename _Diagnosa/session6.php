        ...
        <form id="diagnosis-form" onsubmit="saveFormData(event, 'result.php')">
            <div class="question-session active">
                ...
                <div class="form-group">
                    <button type="button" class="option-btn" data-field="stress_level" data-value="high" onclick="selectOption(this, 'stress_level', 'high')">Tinggi</button>
                    <button type="button" class="option-btn" data-field="stress_level" data-value="moderate" onclick="selectOption(this, 'stress_level', 'moderate')">Sedang</button>
                    <button type="button" class="option-btn" data-field="stress_level" data-value="low" onclick="selectOption(this, 'stress_level', 'low')">Rendah</button>
                    <input type="hidden" id="stress_level" name="stress_level" required>
                </div>
                <h2>Apakah Anda sering merasa cemas atau depresi?</h2>
                <div class="form-group">
                    <button type="button" class="option-btn" data-field="anxiety" data-value="often" onclick="selectOption(this, 'anxiety', 'often')">Sering</button>
                    <button type="button" class="option-btn" data-field="anxiety" data-value="sometimes" onclick="selectOption(this, 'anxiety', 'sometimes')">Kadang-kadang</button>
                    <button type="button" class="option-btn" data-field="anxiety" data-value="rarely" onclick="selectOption(this, 'anxiety', 'rarely')">Jarang</button>
                    <input type="hidden" id="anxiety" name="anxiety" required>
                </div>
                <h2>Apakah gejala lambung Anda memburuk saat Anda stres?</h2>
                <div class="form-group">
                    <button type="button" class="option-btn" data-field="stress_worsen" data-value="yes" onclick="selectOption(this, 'stress_worsen', 'yes')">Ya</button>
                    <button type="button" class="option-btn" data-field="stress_worsen" data-value="no" onclick="selectOption(this, 'stress_worsen', 'no')">Tidak</button>
                    <button type="button" class="option-btn" data-field="stress_worsen" data-value="not_sure" onclick="selectOption(this, 'stress_worsen', 'not_sure')">Tidak yakin</button>
                    <input type="hidden" id="stress_worsen" name="stress_worsen" required>
                </div>
            </div>
